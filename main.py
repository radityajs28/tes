...
def predict():
    ...
    model_dict = {'Skenario1'    :   'static/MLModule/Model1.h5',
                    'Skenario2'  : 'static/MLModule/Model2.h5',
                  'Skenario3'    :   'static/MLModule/Model3.h5',}
...
def predict_result(model, run_time, probs, img):
    class_list = {'V': 'V', 'I': 'I', 'L': 'L', 'del': 'del', 'N': 'N', 'T': 'T', 'B': 'B', 'S': 'S', 'K': 'K', 'Y': 'Y', 'X': 'X', 'J': 'J', 'nothing': 'nothing', 'H': 'H', 'A': 'A', 'C': 'C', 'R': 'R', 'Q': 'Q', 'space': 'space', 'O': 'O', 'Z': 'Z', 'M': 'M', 'E': 'E', 'W': 'W', 'F': 'F', 'P': 'P', 'G': 'G', 'U': 'U', 'D': 'D', 'other': 'other'}
